...
func Test_AppendBool(t *testing.T) {
	// AppendBool(dest []byte, b bool) []byte
	rst := make([]byte, 0)
...
// 其中的特殊字符将被转换为“转义字符”
func Test_AppendQuota(t *testing.T) {
	// func AppendQuota(dst []byte, s string) []byte
	s := `C:\Windows`
	b := make([]byte, 0)
...
func Test_QuoteToASCII(t *testing.T) {
...
func Test_AppendQuoteToASCII(t *testing.T) {
...
func Test_QuoteRune(t *testing.T) {
...
// 并将结果追加到 dst 的尾部，返回追加后的 []byte
// “特殊字符”将被转换为“转义字符”
func Test_AppendQuoteRune(t *testing.T) {
...
// “非 ASCII 字符”和“特殊字符”将被转换为“转义字符”
func Test_QuoteRuneToASCII(t *testing.T) {
...
func Test_AppendQuoteRuneToASCII(t *testing.T) {
...
func Test_CanBackupquote(t *testing.T) {
	// func CanBackupquote(s string) bool
...
func Test_UnquoteChar(t *testing.T) {
